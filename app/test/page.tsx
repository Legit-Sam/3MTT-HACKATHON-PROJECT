...
// //         <p className="text-yellow-500 font-bold">Management</p>
// //         <h2 className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
// //           Smart Solutions for Waste and Recycling
// //         </h2>
// //         <p className="mt-4 text-gray-500">
// //           Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut tincidunt
// //           faucibus velit eget condimentum. Curabitur pharetra, urna ac
// //           tristique congue, orci orci hendrerit dolor, et vulputate metus dui
// //           ut justo.
// //         </p>
// //       </div>
...
// //             <div className="bg-green-700 text-white p-3 rounded-md">
// //               <svg
// //                 xmlns="http://www.w3.org/2000/svg"
// //                 className="h-6 w-6"
// //                 fill="none"
...
//       date: "March 25, 2024",
//       category: "deka",
//       image: "/images/eco-friendly.jpg", // Replace with actual image paths
//       description:
//         "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi faucibus cursus augue, eget posuere ligula suscipit ut. Vestibulum ac felis bibendum, fermentum erat vel, aliquam leo.",
//     },
//     {
...
//       date: "March 25, 2024",
//       category: "deka",
//       image: "/images/recycling-tips.jpg",
//       description:
//         "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi faucibus cursus augue, eget posuere ligula suscipit ut. Vestibulum ac felis bibendum, fermentum erat vel, aliquam leo.",
//     },
//   ];
...
//         <p className="text-green-600 font-bold">Blog & News</p>
//         <h2 className="mt-4 text-4xl font-extrabold text-gray-900">
//           Read Our Latest News & Blog
//         </h2>
//         <p className="mt-4 text-gray-500">
//           Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
//           faucibus cursus augue, eget posuere ligula suscipit ut. Vestibulum ac
//           felis bibendum, fermentum erat vel, aliquam leo. Nullam id scelerisque
//           elit.
//         </p>
...
//               />
//               <div className="p-6">
//                 <p className="text-green-600 font-bold">{blog.category}</p>
//                 <p className="text-gray-400 text-sm mt-1">{blog.date}</p>
//                 <h3 className="mt-4 text-xl font-bold text-gray-900">
//                   {blog.title}
//                 </h3>
//                 <p className="mt-2 text-gray-500">{blog.description}</p>
//                 <button className="mt-4 inline-block bg-yellow-500 text-white py-2 px-4 rounded-md hover:bg-yellow-600">
//                   Read More
//                 </button>
//               </div>
//             </div>
